 ...
 */
type CtxType = Merge<NextPageContext, AppContext>;
type CtxTypeWithApollo = Merge<
  CtxType,
  {
    apolloClient: any;
    apolloState: any;
...
>;
export const initOnContext = (ctx: CtxTypeWithApollo | null) => {
 ...
 */
const initApolloClient = (initialState: NormalizedCacheObject, ctx: NextPageContext | null) => {
